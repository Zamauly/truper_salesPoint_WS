...
public class ActiveUserDetails implements UserDetails {
	...
	public ActiveUserDetails(Long id, String username, String email, String password,
	...
	public static ActiveUserDetails build(ActiveUser activeUser) {
		List<GrantedAuthority> authorities = activeUser.getRoles().stream()
	...
	public boolean equals(Object o) {
		...
		if (o == null || getClass() != o.getClass())
			return false;
		ActiveUserDetails user = (ActiveUserDetails) o;
